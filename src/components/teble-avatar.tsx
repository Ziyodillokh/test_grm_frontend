...
import { Check, CircleAlert, FileOutput, X } from "lucide-react";
...
const statusObj=  {
  ...
  return:()=> <div className=" flex items-center justify-center   border-white border-[1.5px]  absolute  bottom-[-2px] left-[-2px] w-[17px] h-[17px] rounded-full bg-[#EC6C49]"><FileOutput  stroke="white"    className=" w-[11px]" /></div>,
  none:()=><></>
}
