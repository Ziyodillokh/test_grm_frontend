...
// Yangi xabarlar itemlari uchun mock data
const notifications = [
  {
    id: 1,
    icon: "📋",
...
export default function LoginFormContent({
  ...
  return (
    <div className="h-screen w-screen flex flex-col bg-[#f5f5f5] overflow-hidden">
      {/* Top bar — 90px */}
      <header className="h-[90px] shrink-0 flex items-center justify-between px-[20px] bg-white border-b border-[#e8e8e8]">
        ...
        <button className="flex items-center gap-2 text-[15px] text-[#272727]">
      ...
      >
        ...
        >
          ...
          {/* Section headerlar — logo dan 50px pastda */}
          <div className="flex gap-0 mt-[50px]">
            <span className="text-[15px] text-[#8a8a8a] font-normal">Bugun</span>
          </div>

          {/* Soat bloki — headerdan 16px pastda */}
          <div className="mt-[16px] flex items-end gap-[40px]">
            {/* Soat + sana */}
            <div>
          ...
          <div className="mt-[24px]">
            ...
            {/* Yashirin submit button — Enter bilan ishlaydi */}
        ...
        {/* O'NG TOMON — 10 column */}
        <div
          className="flex flex-col pt-[50px] pb-[20px]"
          style={{ gridColumn: "7 / 17" }}
        >
          {/* Section headerlar */}
          <div className="flex justify-between mb-[16px]">
            <span className="text-[15px] text-[#8a8a8a]">Ko'rsatkichlar</span>
            <span className="text-[15px] text-[#8a8a8a]">
              Murojaatlar, talablar va takliflar +4
            </span>
          </div>

          {/* Ko'rsatkichlar row + Carousel */}
          <div className="flex gap-[20px]">
            ...
            {/* Carousel — qolgan joy */}
            <div className="flex-1 h-[570px] rounded-2xl overflow-hidden relative bg-[#1a1a1a]">
              <Carousel
