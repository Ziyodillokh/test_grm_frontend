  ...
  return (
    <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
      <div className="flex flex-col h-full">
        ...
        {/* Cards: yashil (income/inHand/plasticSum) + 4 oq (debt/discount/frozen) */}
        <div className="flex gap-[4px] flex-col lg:flex-row">
          ...
          >
            <p className="text-[20px] font-medium leading-tight">
              ${Number(kassa?.income || 0).toLocaleString("uz-UZ", { minimumFractionDigits: 2 })}
            </p>
            <div className="flex items-center gap-[16px]">
              <span className="text-[15px] font-normal opacity-80 flex items-center gap-[4px]">
                <Banknote className="w-4 h-4" /> ${Number(kassa?.inHand || 0).toLocaleString()}
              </span>
              <span className="text-[15px] font-normal opacity-80 flex items-center gap-[4px]">
                <ArrowDown className="w-4 h-4" /> ${Number(kassa?.plasticSum || 0).toLocaleString()}
              </span>
            </div>
          </div>

          {/* 4 oq card — debtSum, debtSize, discountSum, frozenOwed */}
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-[4px] flex-1" style={{ maxHeight: 80 }}>
            ...
            <div className="bg-white rounded-sm flex flex-col gap-[2px]" style={{ padding: 10 }}>
              ...
              <p className="text-[13px] text-[#1a1a1a] opacity-60">Chegirma</p>
            </div>
            <div className="bg-white rounded-sm flex flex-col gap-[2px]" style={{ padding: 10 }}>
