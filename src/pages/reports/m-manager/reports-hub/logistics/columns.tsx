...
import { LogisticsReportItem, LogisticsDetailItem } from "./type";

export const LogisticsColumns: ColumnDef<LogisticsReportItem>[] = [
  {
    header: "Nomi",
    cell: ({ row }) => (
...
export const LogisticsDetailColumns: ColumnDef<LogisticsDetailItem>[] = [
  {
    id: "icon",
    cell: ({ row }) => {
