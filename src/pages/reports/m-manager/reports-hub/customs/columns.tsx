...
import { CustomsReportItem, CustomsDetailItem } from "./type";

export const CustomsColumns: ColumnDef<CustomsReportItem>[] = [
  {
    header: "Nomi",
    cell: ({ row }) => (
...
export const CustomsDetailColumns: ColumnDef<CustomsDetailItem>[] = [
  {
    id: "icon",
    cell: ({ row }) => {
