...
const columnLabels = ["Zavod", "Soni", "Hajm", "Summa", "Foyda"];
          ...
          items.map((item: any, i: number) => (
            <ListRow
              ...
              onClick={() => {
                ...
                push(item.title || "Kolleksiya", path);
                navigate(path);
              }}
            >
              <span className="text-[13px] font-medium text-[#1a1a1a]">{item.title || item?.factory?.title}</span>
