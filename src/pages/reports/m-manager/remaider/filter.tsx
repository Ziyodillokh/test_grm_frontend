      ...
      <Popover open={filterOpen} onOpenChange={setFilterOpen}>
        ...
        >
          ...
          <div className="flex flex-col gap-[10px]">
            ...
            {isManager && (
              <div>
                <p className="text-[12px] text-[#A3A3A3] mb-[4px] px-[4px]">Filial</p>
            ...
            {/* Ko'rinish: Filial / Partiya */}
            {isManager && (
              <div>
                <p className="text-[12px] text-[#A3A3A3] mb-[4px] px-[4px]">Ko'rinish</p>
                <div className="bg-white rounded-[8px]">
                  <FilterSelect
                    placeholder="Turi"
                    className="w-full"
