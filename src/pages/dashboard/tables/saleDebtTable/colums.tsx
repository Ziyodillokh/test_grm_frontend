...
import {  Delete, SquareArrowOutDownLeft } from "lucide-react";
          ...
          return (
            <div className="flex items-center ">
                <div
                  ...
                  >
                    {
                    typeSaledebt=="canceled"? <Delete  className={`h-6 w-6  text-[#D76B43] `} />:    <SquareArrowOutDownLeft className={`h-6 w-6  text-[#D76B43] `} />
                    }
